...
namespace TDGame.Internals.Common.GameUI
{
    public class UIImageButton : UIImage
    {
        ...
        public override void Draw() {
            ...
            TowerDefense.spriteBatch.Draw(Texture, InteractionBox.Position, null, Color.White * (MouseHovering ? 1.0f : 0.8f), Rotation, Vector2.Zero, Scale, SpriteEffects.None, 0f);
        }
    }
}